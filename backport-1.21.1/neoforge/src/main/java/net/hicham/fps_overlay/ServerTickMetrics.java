...
public final class ServerTickMetrics {
    ...
    public static void onJoinServer(Connection connection) {
        ...
        if (connection != null) {
            connection.send(new ServerboundDebugSampleSubscriptionPacket(RemoteDebugSampleType.TICK_TIME));
        }
    }
    ...
    public static boolean isTier1Active() {
        return (System.nanoTime() - tier1LastReceivedNano.get()) < 2_000_000_000L;
    }

    public static boolean isTier2Active() {
        return (System.nanoTime() - tier2LastReceivedNano.get()) < 3_000_000_000L;
    }
}
