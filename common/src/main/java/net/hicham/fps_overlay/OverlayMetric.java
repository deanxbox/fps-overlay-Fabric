...
public enum OverlayMetric {
    ...
    AVG_FRAME_TIME("avg_frame_time", "text.fps_overlay.avg_frame_time_short", "text.fps_overlay.avg_frame_time", "text.fps_overlay.ms"),
    ...
    FRAME_TIME_HIGH_1("one_percent_frame_time_high", "text.fps_overlay.1percent_frame_time_high_short", "text.fps_overlay.1percent_frame_time_high", "text.fps_overlay.ms"),
    FRAME_TIME_HIGH_01("point_one_percent_frame_time_high", "text.fps_overlay.0_1percent_frame_time_high_short", "text.fps_overlay.0_1percent_frame_time_high", "text.fps_overlay.ms"),
